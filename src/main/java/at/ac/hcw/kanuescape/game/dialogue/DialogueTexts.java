...
public class DialogueTexts {
    ...
    public static final Map<String, List<String>> VARIANTS = Map.ofEntries(
            ...
            entry("picture", List.of(
                    "At the university, a nerdy student spent most of his days surrounded by",
                    " three towers of books, focused on one upcoming exam.In, his, backpack, were, two, ",
                    "notebooks, five, textbooks, and, four, folders, filled, with, notes.",
                    "",
                    "During late-night study sessions, four friends joined him with five cups of coffee.",
                    "Together they reviewed three chapters, solved two practice tests, and finally",
                    "understood one difficult subject.",
                    "",
